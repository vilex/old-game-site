(function() {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/config-white-list-wap.js", function(require, exports, module) {
        ...
        var wlist = {
            ...
            beWhiteList: [ "mobile_login_external_platform", "domain_whitelist", "extensions", "mobile_allow_upload_img", "user_portrait_url", "mobile_allow_barrage", "comment_recom_image", "mobile_latest_page_num", "disable_user_photo", "mobile_float_bar", "mobile_isv_type", "mobile_hot_page_num", "mobile_css_type", "hot_page_num", "v3_hack", "mobile_extensions_key", "sso", "sso_isv_login", "sso_isv_logout", "sso_isv_userInfo", "sso_type", "only_sso", "mobile_isv_login_icon", "mobile_isv_login_url", "is_new_cdn" ]
        };
            ...
            openLoginDialog: function(tag) {
                ...
                if (window.changyan.loginDialog) {
                    ...
                    if ($$data.get("beConfig:extensions_key").indexOf("v3.2") >= 0) {
                        $$util.loadJs($$data.get("config:base") + "mdevp/extensions/login-dialog/018/login-dialog.js", function() {
                            that.LoginMode(tag);
                        });
                    } else {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/login-normal.js", function(require, exports, module) {
        ...
        var AjaxMutex = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/ajax-mutex.js");
        var ajaxMutex;
        ...
        var login = {
            getUserInfo: function(fn) {
                ...
                var fail = function(data) {
                    console.log("ajax get user info error");
                };
                ajaxMutex.startWithMutex(options, success, fail);
            },
            logout: function() {
                var loadScripts = function() {
                    return function(urls) {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/ajax-mutex.js", function(require, exports, module) {
        var $ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/jquery-1.7.0.js");
        var Mutex = function(status, QueueNumber) {
            this._running = status;
            this._queues = this.initQueues(QueueNumber);
            this._queueSum = QueueNumber;
        };
        Mutex.prototype = {
            initQueues: function(number) {
                var queues = [];
            ...
            pushQueue: function(queueIndex, ele) {
                if (queueIndex >= this._queueSum || queueIndex < 0) return false;
                if (this._queues[queueIndex] instanceof Array) {
                    this._queues[queueIndex].push(ele);
                }
            },
            popQueue: function(queueIndex) {
                if (queueIndex >= this._queueSum || queueIndex < 0) return false;
                if (this._queues[queueIndex] instanceof Array) {
                    return this._queues[queueIndex].shift();
                }
            },
            emptyQueue: function() {
                this._queues = [];
        ...
        var AjaxMutex = function(repeat) {
            this._mutex = new Mutex(false, 2);
            this._repeat = repeat;
            this._haveDone = false;
            this._successData = undefined;
            this._failData = undefined;
        };
        AjaxMutex.prototype = {
            sendAjax: function(options, successFn, failFn) {
            ...
            sendAjaxWithQueue: function(options) {
                var _this = this;
                options.success = function(data) {
                    _this._successData = data;
                    _this._haveDone = true;
                    var tmpFn = undefined;
                    while (tmpFn = _this._mutex.popQueue(0)) {
                        tmpFn(data);
                    }
                    _this._mutex.setOff();
                    _this._mutex.emptyQueue();
                    delete options.success;
                    delete options.success;
                };
                options.error = function(data) {
                    var _this = this;
                    _this._failData = data;
                    _this._haveDone = false;
                    var tmpFn = undefined;
                    while (tmpFn = _this._mutex.popQueue(1)) {
                        tmpFn(data);
                    }
                    _this._mutex.setOff();
                    _this._mutex.emptyQueue();
            ...
            startWithMutex: function(options, successFn, failFn) {
                if (!this._repeat && this._haveDone) {
                    successFn(this._successData);
                    return;
                }
                if (!this._mutex.getStatus()) {
                    this._mutex.setOn();
                    this._mutex.pushQueue(0, successFn);
                    this._mutex.pushQueue(1, failFn);
                    this.sendAjaxWithQueue(options, successFn, failFn);
                } else {
                    this._mutex.pushQueue(0, successFn);
                    this._mutex.pushQueue(1, failFn);
                }
            },
            startNormal: function(options, successFn, failFn) {
                this.sendAjax(options, successFn, failFn);
            },
            stopMutex: function(options, successFn, failFn) {}
        };
        module.exports = AjaxMutex;
    });
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/sso/sso-init.js", function(require, exports, module) {
        var $ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/jquery-1.7.0.js"), _ = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/lib/underscore-1.8.2.js"), $$data = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/data-center.js"), $$event = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/events.js"), $$login = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/login-normal.js"), AjaxMutex = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/ajax-mutex.js"), ajaxMutex = undefined;
        var loadScripts = function() {
            return function(urls) {
                var ret = [];
                for (var i = 0; i < urls.length; i++) {
        ...
        var getIsvUserInfo = function(fn) {
            ...
            var fail = function(data) {
                console.log("ajax get isv user info error");
            };
            ajaxMutex.startWithMutex(options, success, fail);
        };
        module.exports = {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/login-platform-mobile.js", function(require, exports, module) {
        ...
        var mobileLogin = {
                            ...
                            $.ajax({
                                ...
                                success: function(msg) {
                                    if (msg.msg === "seed success") {
                                        phoneData.fn(msg);
                                        api.event.trigger("changyan:login");
                                    }
                                }
                            });
                        } else {
            ...
            other: function(platform_id) {
                ...
                window.location.href = "http://changyan.sohu.com/api/2/login/passport?client_id=" + params.clientId + "&platform_id=" + params.platform_id + "&url=" + params.url + "&isMobile=true&connName=changyan_wap";
            }
        };
        ...
        var wechatObj = {
            ...
            wechatOpen: function() {
                ...
                if (window.changyan.wechatOperate) {
                    ...
                    $$util.loadJs($$data.get("config:base") + "mdevp/extensions/wechat-bind/015/wechat-bind.js", function() {
                        that.wechatBind.inPageBind = window.changyan.wechatOperate.inPageBind;
                        that.wechatBind.outPageBind = window.changyan.wechatOperate.outPageBind;
                    });
                }
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/version/extensions.json.js", function(require, exports, module) {
        module.exports = {
            ...
            "v3.2": "cy-skin/013/cy-skin.js,cmt-header/044/cmt-header.js,cmt-box/034/cmt-box.js,cmt-list/040/cmt-list.js,cmt-footer/024/cmt-footer.js,hot-topic/016/hot-topic.js,face/008/face.js,cmt-float-bar/024/cmt-float-bar.js,cy-user-page/023/cy-user-page.js,cy-user-info/036/cy-user-info.js,cy-user-avatar/013/cy-user-avatar.js,cy-user-view/019/cy-user-view.js,cy-user-footprint/009/cy-user-footprint.js,cy-report/013/cy-report.js,cy-user-notice/031/cy-user-notice.js,cy-user-feedback/037/cy-user-feedback.js,cy-user-set/005/cy-user-set.js,cmt-notice-no-task-msg/006/cmt-notice-no-task-msg.js,cy-grade/007/cy-grade.js,cy-score/005/cy-score.js,jump-url/006/jump-url.js,disable-user-photo/006/disable-user-photo.js,sohu-treaty/005/sohu-treaty.js,cy-auto-recommand/004/cy-auto-recommand.js,phone-verify/003/phone-verify.js,first-login-prompt/002/first-login-prompt.js",
            "17173-v3.2": "cy-skin/013/cy-skin.js,cmt-header/044/cmt-header.js,cmt-box/034/cmt-box.js,cmt-list/040/cmt-list.js,cmt-footer/024/cmt-footer.js,hot-topic/016/hot-topic.js,face/008/face.js,cmt-float-bar/024/cmt-float-bar.js,cy-user-page/023/cy-user-page.js,cy-user-info/036/cy-user-info.js,cy-user-avatar/013/cy-user-avatar.js,cy-user-view/019/cy-user-view.js,cy-user-task/024/cy-user-task.js,cy-user-footprint/009/cy-user-footprint.js,cy-prop/040/cy-prop.js,cy-report/013/cy-report.js,cy-user-notice/031/cy-user-notice.js,cy-user-feedback/037/cy-user-feedback.js,cy-user-set/005/cy-user-set.js,cmt-notice/017/cmt-notice.js,cy-grade/007/cy-grade.js,cy-score/005/cy-score.js,jump-url/006/jump-url.js,disable-user-photo/006/disable-user-photo.js,cy-auto-recommand/004/cy-auto-recommand.js,first-login-prompt/002/first-login-prompt.js,http://ue.17173cdn.com/a/lib/chanyan/passport.js",
            "prop-v3.2": "cy-skin/013/cy-skin.js,cmt-header/044/cmt-header.js,cmt-box/034/cmt-box.js,cmt-list/040/cmt-list.js,cmt-footer/024/cmt-footer.js,hot-topic/016/hot-topic.js,face/008/face.js,cmt-float-bar/024/cmt-float-bar.js,cy-user-page/023/cy-user-page.js,cy-user-info/036/cy-user-info.js,cy-user-avatar/013/cy-user-avatar.js,cy-user-view/019/cy-user-view.js,cy-user-task/024/cy-user-task.js,cy-user-footprint/009/cy-user-footprint.js,cy-prop/040/cy-prop.js,cy-report/013/cy-report.js,cy-user-notice/031/cy-user-notice.js,cy-user-feedback/037/cy-user-feedback.js,cy-user-set/005/cy-user-set.js,cmt-notice/017/cmt-notice.js,cy-grade/007/cy-grade.js,cy-score/005/cy-score.js,jump-url/006/jump-url.js,disable-user-photo/006/disable-user-photo.js,sohu-treaty/005/sohu-treaty.js,cy-auto-recommand/004/cy-auto-recommand.js,phone-verify/003/phone-verify.js,first-login-prompt/002/first-login-prompt.js",
            "cyqE875ep-v3.2": "cy-skin/013/cy-skin.js,cmt-header/044/cmt-header.js,cmt-box/034/cmt-box.js,cmt-list/040/cmt-list.js,hot-topic/016/hot-topic.js,cmt-footer/024/cmt-footer.js,face/008/face.js,cmt-float-bar/024/cmt-float-bar.js,cy-report/013/cy-report.js,cy-grade/007/cy-grade.js,cy-score/005/cy-score.js,jump-url/006/jump-url.js,disable-user-photo/006/disable-user-photo.js",
            "wap-prop": "mobile-enter/019/mobile-enter.js,mobile-skin/018/mobile-skin.js,mobile-cmt-box/016/mobile-cmt-box.js,mobile-cmt-header/020/mobile-cmt-header.js,mobile-cmt-list/024/mobile-cmt-list.js,mobile-login-box/015/mobile-login-box.js,mobile-user-center/019/mobile-user-center.js,mobile-cmt-float-bar/019/mobile-cmt-float-bar.js,mobile-task/012/mobile-task.js,mobile-cmt-barrage/012/mobile-cmt-barrage.js,mobile-auto-recommand/010/mobile-auto-recommand.js"
        };
    });
